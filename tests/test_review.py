...
class TestReview(unittest.TestCase):
    ...
    def setUp(self):
        self.user_Marion = User(username = 'Marion', password ='potato', email = 'devsarahmarion@gmail.com')
        self.new_review = Review(movie_id=12345, movie_title='Review for movies', image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn", movie_review='This movie is the best thing since sliced bread',user=self.user_Marion)
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_review.user, self.user_Marion)
